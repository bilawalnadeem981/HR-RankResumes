    ...
    >
      <div className="max-w-7xl mx-auto px-4 flex justify-between items-center">
        ...
        <div className="flex items-center gap-4">
          <Link to="/login" className="hidden sm:block text-gray-700 font-semibold hover:text-indigo-600 transition-colors">
            Login
          </Link>
          <Link to="/signup" className="bg-indigo-600 hover:bg-indigo-700 text-white px-6 py-2.5 rounded-lg font-semibold shadow-md hover:shadow-lg active:scale-95 transition-all">
            Get Started
          </Link>
        </div>
      </div>
